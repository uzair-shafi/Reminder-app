<template>
  ...
  >
    <div class="container">
        ...
        <div>
          <div class="flex flex-row items-center gap-0">
            <h1 class="text-2xl md:text-3xl font-bold tracking-tighter mt-6">
              {{ reminder?.title || "Loading..." }}
            </h1>
          </div>
          <p class="text-l text-[#191919] tracking-tight mt-2">
            {{ reminder?.description || "Loading..." }}
          </p>

          <div
            class="text-sm inline-flex border border-[#222]/20 mt-6 px-3 py-1 rounded-lg tracking-tight"
          >
            <span class="font-semibold pr-2">Duration: </span>
            {{ reminder?.duration || "Loading..." }}
          </div>
          <div
            class="lg:ml-2 text-sm inline-flex border border-[#222]/20 mt-6 px-3 py-1 rounded-lg tracking-tight"
          >
      ...
      <div
        class="lg:max-w-[80%] max-w-[100%] flex flex-col justify-start mt-14"
      >
          ...
          >
            <div class="flex flex-row gap-6">
              ...
              <div class="flex flex-col lg:pb-[0px] pb-[50px] gap-2">
                <p
                  class="text-[20px] text-[#191919] font-semibold"
